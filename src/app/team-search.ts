...
@Component({
  ...
  imports: [
    ...
    HyShellModule, HyTagModule, HyGhostModule,
  ],
  template: `
    <hy-shell-view title="Teams" />
    <div class="container">
      <div class="header-row">
        <mat-form-field hyFormField class="search-field">
          <mat-label>Search teams</mat-label>
          <input matInput [(ngModel)]="searchQuery" (ngModelChange)="onSearch()" placeholder="team name..." />
          <mat-icon matSuffix hyIcon>search</mat-icon>
        </mat-form-field>
